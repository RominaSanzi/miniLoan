<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/BaseIncludes.master"
    CodeBehind="PasanteModificar.aspx.vb" Inherits="di.financiera.webResponsive.PasanteModificar" %>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <cc1:IntegerBox Enabled="True" ID="intDNI" UsaSeparadorPuntos="true"
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox Enabled="True" ID="txtNombreApellido" TabIndex="1" runat="server"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <cc1:DateBox Enabled="True" ID="dtbFechaNacimiento" TabIndex="6" runat="server"
                                ...
                                <div class="row align-items-end">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox Enabled="True" ID="txtEmail" runat="server"
                                ...
                                <div class="row align-items-end">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <cc1:IntegerBox Enabled="True" ID="intCUIL" UsaSeparadorPuntos="false"
                                                TabIndex="8" runat="server" CssClass="form-control "
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox Enabled="True" ID="txtCalle" TabIndex="1" runat="server"
                                                CssClass="form-control " Width="100%" MaxLength="40"
                                                AutoPostBack="false" AutoComplete="False" ClientIDMode="Static"
                                                required="required">
                                            </asp:TextBox>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <cc1:IntegerBox Enabled="True" ID="intNumero" UsaSeparadorPuntos="false"
                                                TabIndex="8" runat="server" CssClass="form-control "
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <cc1:IntegerBox Enabled="True" ID="intPiso" UsaSeparadorPuntos="false"
                                                TabIndex="8" runat="server" CssClass="form-control"
                                                Width="100%" AutoComplete="False" MaxLength="12" ClientIDMode="Static"
                                                required="required">
                                            </cc1:IntegerBox>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <cc1:IntegerBox Enabled="True" ID="intCodigoPostal" UsaSeparadorPuntos="false"
                                                TabIndex="8" runat="server" CssClass="form-control "
                                                Width="100%" AutoComplete="False" MaxLength="12" ClientIDMode="Static"
                                                required="required">
                                            </cc1:IntegerBox>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <cc1:IntegerBox Enabled="True" ID="intLegajoEscuela" UsaSeparadorPuntos="false"
                                                TabIndex="8" runat="server" CssClass="form-control "
                                                Width="100%" AutoComplete="False" MaxLength="12" ClientIDMode="Static"
                                                required="required">
                                            </cc1:IntegerBox>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <cc1:DateBox Enabled="True" ID="dtbFechaInicio" TabIndex="6" runat="server"
                                                CssClass="form-control fecha datepicker "
                                                AutoComplete="False" ClientIDMode="Static" Width="100%" required="required">
                                            </cc1:DateBox>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <cc1:DateBox Enabled="True" ID="dtbFechaFinalizacion" TabIndex="6" runat="server"
                                                CssClass="form-control fecha datepicker "
                                                AutoComplete="False" ClientIDMode="Static" Width="100%" required="required">
                                            </cc1:DateBox>
                                        </div>
