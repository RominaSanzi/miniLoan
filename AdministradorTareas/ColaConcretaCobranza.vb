...
Public Class ColaConcretaCobranza : Implements Cola
...
#Region "Variables"
    ...
    Private Shared iInstancia As ColaConcretaCobranza
...
#Region "Metodos"
    Public Shared Function getInstancia() As ColaConcretaCobranza
        Try
            iMutex.WaitOne()
            If iInstancia Is Nothing Then iInstancia = New ColaConcretaCobranza()
            iMutex.ReleaseMutex()
            Return iInstancia
