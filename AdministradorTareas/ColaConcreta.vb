...
Public Class ColaConcreta : Implements Cola
...
#Region "Variables"
    ...
    Private Shared iInstancia As ColaConcreta
...
#Region "Metodos"
    Public Shared Function getInstancia() As ColaConcreta
        Try
            iMutex.WaitOne()
            If iInstancia Is Nothing Then iInstancia = New ColaConcreta()
            iMutex.ReleaseMutex()
            Return iInstancia
