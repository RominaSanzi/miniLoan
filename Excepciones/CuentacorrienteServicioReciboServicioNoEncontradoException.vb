...
Public Class CuentacorrienteServicioReciboServicioNoEncontradoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo encontrar el CuentacorrienteServicioReciboServicio en la base de datos."
    End Sub
