...
Public Class EntidadMutualCategoriaCuotaSocialNoEliminadaException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo eliminar la entidad mutual categoria cuota social en la base de datos."
    End Sub
