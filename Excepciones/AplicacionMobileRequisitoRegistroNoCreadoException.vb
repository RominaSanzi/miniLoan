Public Class AplicacionMobileRequisitoRegistroNoCreadoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo crear el Requisito de Registro de la Aplicacion Mobile en la base de datos."
    End Sub
