...
Public Class ParametroEntidadRecaudadoraNoActualizadoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo actualizar el parametro entidad recaudadora en la base de datos."
    End Sub
