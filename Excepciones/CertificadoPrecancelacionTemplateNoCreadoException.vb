Public Class CertificadoPrecancelacionTemplateNoCreadoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo crear el Certificado Precancelacion Template en la base de datos."
    End Sub
