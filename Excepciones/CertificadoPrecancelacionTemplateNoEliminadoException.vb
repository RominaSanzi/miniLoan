Public Class CertificadoPrecancelacionTemplateNoEliminadoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo eliminar el Certificado Precancelacion Template en la base de datos."
    End Sub
