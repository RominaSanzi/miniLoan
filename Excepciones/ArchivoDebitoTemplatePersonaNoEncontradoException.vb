Public Class ArchivoDebitoTemplatePersonaNoEncontradoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo encontrar ""archivo debito template persona"" en la base de datos."
    End Sub
