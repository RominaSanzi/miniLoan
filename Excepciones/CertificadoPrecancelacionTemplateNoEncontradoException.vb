Public Class CertificadoPrecancelacionTemplateNoEncontradoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo encontrar el Certificado Precancelacion Template en la base de datos."
    End Sub
