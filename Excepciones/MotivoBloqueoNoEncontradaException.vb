Public Class MotivoBloqueoNoEncontradaException
    Inherits MotivoBloqueoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo encontar el motivo de bloqueo en la base de datos."
    End Sub
