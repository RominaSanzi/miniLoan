...
Public Class EntidadMutualCategoriaCuotaSocialNoCreadaException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo crear la entidad mutual categoria cuota social en la base de datos."
    End Sub
