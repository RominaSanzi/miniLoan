...
Public Class EntidadMutualCategoriaCuotaSocialNoModificadaException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo modificar la entidad mutual categoria cuota social en la base de datos."
    End Sub
