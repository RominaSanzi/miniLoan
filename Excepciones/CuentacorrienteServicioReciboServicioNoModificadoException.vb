...
Public Class CuentacorrienteServicioReciboServicioNoModificadoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo modificar <ARTICULO> CuentacorrienteServicioReciboServicio en la base de datos."
    End Sub
