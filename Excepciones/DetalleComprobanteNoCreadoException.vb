Public Class DetalleComprobanteNoCreadoException
    Inherits ComprobanteException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo crear el detalle de comprobante en la base de datos."
    End Sub
