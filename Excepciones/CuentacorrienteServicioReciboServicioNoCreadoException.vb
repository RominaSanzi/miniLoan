...
Public Class CuentacorrienteServicioReciboServicioNoCreadoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo crear <ARTICULO> CuentacorrienteServicioReciboServicio en la base de datos."
    End Sub
