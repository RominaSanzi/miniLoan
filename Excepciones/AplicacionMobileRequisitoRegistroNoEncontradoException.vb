Public Class AplicacionMobileRequisitoRegistroNoEncontradoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo encontrar el Requisito de registro de la Aplicacion Mobile en la base de datos."
    End Sub
