Public Class ParametroEnvioInterfaceNoModificadoException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo modificar el parametro envio interface estado solicitud en la base de datos."
    End Sub
