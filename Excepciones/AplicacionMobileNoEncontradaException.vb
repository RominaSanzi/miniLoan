...
Public Class AplicacionMobileNoEncontradaException
    ...
    Sub New(ByVal eException As Exception)
        MyBase.originalCause = eException
        MyBase.iMensaje = "No se pudo encontrar la Aplicacion Mobile en la base de datos."
    End Sub

    Sub New()
        MyBase.iMensaje = "No se pudo encontrar la AplicacionMobile en la base de datos."
    End Sub
