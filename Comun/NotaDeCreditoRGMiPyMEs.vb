Public Class NotaDeCreditoRGMiPyMEs : Inherits TipoComprobante

#Region "Metodos"

    Public Sub New()
        id = NOTADECREDITORGMIPYMES
        descripcion = "NOTA DE CREDITO RG MIPYMES"
    End Sub
    ...
    Public Overrides Function ToString() As String
        Return "NOTA DE CREDITO RG MIPYMES"
    End Function
#End Region
