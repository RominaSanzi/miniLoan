Public Class NotaDeDebitoRGMiPyMEs : Inherits TipoComprobante

#Region "Metodos"

    Public Sub New()
        id = NOTADEDEBITORGMIPYMES
        descripcion = "NOTA DE DEBITO RG MIPYMES"
    End Sub
    ...
    Public Overrides Function ToString() As String
        Return "NOTA DE DEBITO RG MIPYMES"
    End Function
#End Region
