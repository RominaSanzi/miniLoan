...
#Region "Metodos"
    ...
    Private Function FuncionJava() As String
        ...
        "function FiltroUpLetras() { " & vbNewLine & _
        "   var key = window.event.keyCode; " & vbNewLine & _
        "   if (((key > 64) && (key < 91)) || ((key > 96) && (key < 123)) || (key == 241) || (key == 209) || (key == 32) ) " & vbNewLine & _
        "       return;  " & vbNewLine & _
        "   else {  " & vbNewLine & _
    ...
    Protected Overrides Sub Render(ByVal writer As System.Web.UI.HtmlTextWriter)
        ...
        MyBase.Attributes.Add("onkeypress", "FiltroUpLetras()")
