...
ToolboxData("<{0}:TextBoxUpLetrasNumeros runat=server></{0}:TextBoxUpLetrasNumeros>")> _
Public Class TextBoxUpLetrasNumeros
...
#Region "Metodos"
    Protected Overrides Sub OnPreRender(ByVal e As System.EventArgs)
        ...
        If Not MyBase.Page.ClientScript.IsClientScriptBlockRegistered("TextBoxUpLetrasNumeros") Then
            'Registro todo el script del control
            'Page.ClientScript.RegisterClientScriptBlock(Me.GetType(), "TextBoxUp", FuncionJava())
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "TextBoxUpLetrasNumeros", FuncionJava())
        End If
    End Sub
    ...
    Private Function FuncionJava() As String
        ...
        "function FiltroUpLetrasNumeros() { " & vbNewLine & _
        "   var key = window.event.keyCode; " & vbNewLine & _
        "   if ((key > 47 && key < 58) || ( (key > 64) && (key < 91)) || ((key > 96) && (key < 123)) || (key == 241) || (key == 209) || (key == 32) ) " & vbNewLine & _
        "       return;  " & vbNewLine & _
        "   else {  " & vbNewLine & _
    ...
    Protected Overrides Sub Render(ByVal writer As System.Web.UI.HtmlTextWriter)
        ...
        MyBase.Attributes.Add("onkeypress", "FiltroUpLetrasNumeros()")
